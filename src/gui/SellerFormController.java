...
public class SellerFormController implements Initializable {
	...
	private Seller getFormData() {
		...
		// name
		if (StringUtils.isEmptyOrWhitespaceOnly(txtName.getText())) {
			exception.addError("name", "Field can't be empty");
		}
		obj.setName(txtName.getText());
		
		// email
		if (StringUtils.isEmptyOrWhitespaceOnly(txtEmail.getText())) {
		...
		// base salary
		if (StringUtils.isEmptyOrWhitespaceOnly(txtBaseSalary.getText())) {
